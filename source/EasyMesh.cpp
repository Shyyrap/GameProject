...
bool EasyMesh::Load(const std::string & fileName, Renderer* renderer)
{
    //find file shaders/Cube.gmpesh
...
void EasyMesh::Unload()
{
	delete mVertexArray;
	mVertexArray = nullptr;
}

Texture* EasyMesh::GetTexture(size_t index)
{
